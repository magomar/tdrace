...
description: "Master directory of all 90 circuits in TdRace across Classic, NASCAR, Rallycross, Karting, Off-Road, and F1/GT modalities."
status: active
category: circuits
...
**TdRace** features an expansive catalog of 90 meticulously mapped circuits and off-road venues, stored as vector geometry JSON files under [`tracks/`](../../tracks). The circuit engine in [`crates/arcade-race-core`](../../crates/arcade-race-core) renders road ribbons, kerbs, barrier perimeters, and split-route networks (such as World RX Joker Laps).
...
| :--- | :--- | :---: | :--- |
| **Classic Heritage** | [classic.md](classic.md) | 10 | Asphalt GP ribbons, figure-eight cross-overs, jump raceways, dirt ovals. |
...
| **Rallycross & Mixed-Surface** | [rally.md](rally.md) | 17 | 60/40 Asphalt-Gravel splits, alternative Joker Lap routing (`TrackNetwork`), desert raids (Sahara Dunes). |
| **Karting Arenas** | [kart.md](kart.md) | 15 | Tight-radius hairpin chicanes, high-grip sprint asphalt, curb hopping (Lonato, Genk, Sarno, Wackersdorf). |
| **Extreme Off-Road & Arenas** | [offroad.md](offroad.md) | 15 | Open arena sand dunes, mud bog pits, frozen ice tracks, rhythm stadium whoops, and jump ramps. |
| **Formula 1 & GT Endurance** | [f1_gt.md](f1_gt.md) | 25+ | FIA Grade 1 homologated road courses (Spa, Monza, Silverstone, Suzuka, Circuit de la Sarthe / Le Mans, Nürburgring GP). |
