...
| [020](020_driver_favorite_cars_per_discipline_and_tier.md) | Per-Discipline and Per-Tier Driver Favorite Cars & 12-Pilot Rosters | Feature Spec | `draft` | Expands motorsport rosters to 12 unique pilots per discipline (72 total) and establishes authentic signature vehicle mappings per discipline and tier across DriverCharacter, modules, and race sessions. |
