...
| [025](025_terrain_surface_bifurcation_and_category_tier_gating.md) | Terrain Surface Bifurcation, Vehicle Terrain Interaction, and Category-Tier Gating | Architecture Spec | `draft` | Bifurcates sand into packed dune ribbons vs deep arrestor traps, defines vehicle-terrain interaction coefficients (sand flotation, mud paddles, ice studs), and establishes simulation-backed category and tier gating. |
