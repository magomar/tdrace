...
| [009](009_real_world_car_models_and_garage.md) | Real-World Vehicle Rosters, Physics Balance & Interactive Garage | Feature Spec | `draft` | Migration from prototypical archetypes to authentic real-world motorsport models across 5 modules and 25 categories, with BoP parity, dual-view 2D rendering, and interactive garage showroom. |
...
| [012](012_track_scenery_and_decorative_elements.md) | Track Scenery and Decorative Elements (Grades & Trees) | Feature Spec | `in_progress` | Decorative track elements featuring tiered concrete grandstands and multi-species trees designed for cenital (top-down) recognition with realistic physical car interactions. |
