...
| [018](018_vehicle_telemetry_alignment_and_physics_differentiation.md) | Vehicle Telemetry Alignment and Physics Differentiation | Feature Spec | `draft` | Unify 6-stat performance telemetry across in-game garage and web showroom with custom vector icons, while dynamically hooking up individual vehicle parameters (braking, grip, agility, and aerodynamics) in the simulation engine. |
