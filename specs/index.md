...
| [013](013_player_profile_enhancement_and_career_dossier.md) | Player Profile Enhancement & Career Dossier | Feature Spec | `draft` | Full-screen player profile dossier with integrated driver switcher, multi-level career hierarchy (Global -> Category -> Championship -> Race), stunt points, collision telemetry, and three selectable layout alternatives. |
